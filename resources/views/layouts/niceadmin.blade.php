...
<head>
    ...
    <!-- Favicons -->
    {{-- <link rel="stylesheet" href="{{ asset("NiceAdmin/assets/img/favicon.png") }}"> --}}
...
<body>
    ...
    <aside id="sidebar" class="sidebar">
        ...
        <ul class="sidebar-nav" id="sidebar-nav">
            ...
            <li class="nav-item">
                <a href="{{ route('user.index') }}" class="nav-link collapsed">
                    <i class="bi bi-box"></i>
                    <span>Member</span>
                </a>
            </li>
    ...
    <script>
        ...
        //     var hotelNavLink = document.querySelector('a[href="{{ route('hotel.index') }}"]');

        //     if (hotelNavLink && currentUrl.includes("hotel")) {
        //         hotelNavLink.classList.remove('collapsed');
        //     }
        // });
        document.addEventListener('DOMContentLoaded', function() {
            var currentUrl = window.location.href;
